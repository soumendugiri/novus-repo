...
<body class="hidden hidden-ball smooth-scroll rounded-borders hero-below-caption" data-primary-color="#fa821d">
                ...
                <div id="header-container">
                    ...
                    <div id="clapat-logo" class="hide-ball">
                        <a class="ajax-link" data-type="page-transition" href="index.html">
                            <img class="black-logo" src="{{ asset('web/images/nov-logo.png')}}" alt="ClaPat Logo">
                            <img class="white-logo" src="{{ asset('web/images/nov-logo.png')}}" alt="ClaPat Logo">
                        </a>
                    </div>
                    <!--/Logo -->
    ...
    <script src="{{ asset('web/cdnjs.cloudflare.com/ajax/libs/gsap/3.11.4/gsap.min.js') }}"></script>
	<script src="{{ asset('web/cdnjs.cloudflare.com/ajax/libs/gsap/3.11.4/ScrollTrigger.min.js') }}"></script>
    <script src="{{ asset('web/cdnjs.cloudflare.com/ajax/libs/gsap/3.11.4/Flip.min.js') }}"></script>    
    <script src='{{ asset('web/cdnjs.cloudflare.com/ajax/libs/three.js/r128/three.min.js') }}'></script>
	<script src='{{ asset('web/cdnjs.cloudflare.com/ajax/libs/jquery.imagesloaded/5.0.0/imagesloaded.pkgd.min.js') }}'></script>
	<script src='{{ asset('web/cdnjs.cloudflare.com/ajax/libs/smooth-scrollbar/8.4.0/smooth-scrollbar.js') }}'></script>
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCpK1sWi3J3EbUOkF_K4-UHzi285HyFX5M&amp;sensor=false"></script>
    
    <script src="{{ asset('web/js/clapat.js') }}"></script>

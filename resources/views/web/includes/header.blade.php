    ...
    <div class="logo-bar">
        <div class="container">
            <div class="row">
                <div class="col-sm-3">
                    <div class="logo">
                        <a aria-hidden="true" title="{{ $setting->website_title }}" href="{{ route('homePage') }}"><img style="width: 500px;max-width:500px;" alt="{{ $setting->website_title }}" src="{{ asset('public/web/logo/' . $setting->logo) }}"></a>
                    </div>
                </div>
                <div class="col-sm-9">
...
<div class="responsive-header">
    <div class="res-logo-area">
        <div class="col-sm-9 col-xs-8">
            <a href="{{ route('homePage') }}" title="Elite Esscorts Kolkata"><img src="{{ asset('public/web/images/logo.png') }}" alt="{{ $setting->website_title }}" style="height: 49px;"></a>
        </div>

		...
		<div class="col-md-3">
			...
			<div class="box box-primary">
				<div class="box-body box-profile">
					...
					<img class="profile-user-img img-responsive img-circle" src="{{ custom_asset('/avatar/' . $user->avatar) }}" alt="{{ Auth::user()->name }}">
					@else
					<img class="profile-user-img img-responsive img-circle" src="{{ custom_asset('/avatar/user.png') }}" alt="{{ Auth::user()->name }}">
					@endif
